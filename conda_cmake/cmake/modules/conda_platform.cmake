...
set(CONDA_COMPILER_NAME "")
set(CONDA_SYSTEM_VERSION_NAME "")
set(CONDA_LINUX_NAME "Unknown")

#For Linux, the folowing varaible will be set
#CONDA_LINUX_NAME		= Fedora, CentOS, RedHat, Ubuntu, openSUSE
...
if(WIN32)
    ...
    IF (MSVC)
        if(MSVC_VERSION EQUAL 1200)
            set(CONDA_COMPILER_NAME "MSVC-6.0")
        endif(MSVC_VERSION EQUAL 1200)
        if(MSVC_VERSION EQUAL 1300)
            set(CONDA_COMPILER_NAME "MSVC-7.0")
        endif(MSVC_VERSION EQUAL 1300)
        if(MSVC_VERSION EQUAL 1310)
            set(CONDA_COMPILER_NAME "MSVC-7.1-2003") #Visual Studio 2003
        endif(MSVC_VERSION EQUAL 1310)
        if(MSVC_VERSION EQUAL 1400)
            set(CONDA_COMPILER_NAME "MSVC-8.0-2005") #Visual Studio 2005
        endif(MSVC_VERSION EQUAL 1400)
        if(MSVC_VERSION EQUAL 1500)
            set(CONDA_COMPILER_NAME "MSVC-9.0-2008") #Visual Studio 2008
        endif(MSVC_VERSION EQUAL 1500)
    endif(MSVC)
    IF (MINGW)
        set(CONDA_COMPILER_NAME "MinGW")
    endif(MINGW)
    IF (CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64")
        set(CONDA_SYSTEM_VERSION_NAME "${CONDA_SYSTEM_VERSION_NAME}-x86_64")
    endif(CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64")
endif(WIN32)

if(UNIX)
    if(CMAKE_SYSTEM_NAME MATCHES "Linux")
        set(CONDA_SYSTEM_VERSION_NAME "${CMAKE_SYSTEM_NAME}")
        if(EXISTS "/etc/issue")
            set(CONDA_LINUX_NAME "")
            file(READ "/etc/issue" LINUX_ISSUE)
            # Fedora case
            if(LINUX_ISSUE MATCHES "Fedora")
                string(REGEX MATCH "release ([0-9]+)" FEDORA "${LINUX_ISSUE}")
                set(CONDA_LINUX_NAME "Fedora")
            ...
            if(LINUX_ISSUE MATCHES "Scientific Linux")
                ...
                set(CONDA_LINUX_NAME "ScientificLinux")
                set(LINUX_VER "${CMAKE_MATCH_1}")
            ...
            if(NOT SYSTEM_NAME)
                ...
                set(CONDA_LINUX_NAME "${CMAKE_MATCH_1}")
                set(LINUX_VER "${CMAKE_MATCH_2}")
                set(SYSTEM_NAME "${CONDA_LINUX_NAME}")
                if(EXISTS "/etc/debian_version")
                    set(DEB_SYSTEM_NAME "${CONDA_LINUX_NAME}")
                endif()
            endif()
            ...
            if ((CONDA_LINUX_NAME STREQUAL "Debian") OR (CONDA_LINUX_NAME STREQUAL "Ubuntu"))
            ...
            if(CONDA_LINUX_NAME)
                set(CONDA_SYSTEM_VERSION_NAME "${CMAKE_SYSTEM_NAME}-${CONDA_LINUX_NAME}-${LINUX_VER}")
            else()
                set(CONDA_LINUX_NAME "NOT-FOUND")
            endif(CONDA_LINUX_NAME)
    ...
    set(CONDA_SYSTEM_VERSION_NAME "${CONDA_SYSTEM_VERSION_NAME}-${CMAKE_SYSTEM_PROCESSOR}")
    set(CONDA_COMPILER_NAME "")
